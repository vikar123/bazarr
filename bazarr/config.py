...
defaults = {
    ...
    'subsync': {
        ...
        'debug': 'False',
        'use_avanced_options': 'False',
        'use_reftrack': 'False',
        'use_reftrack_fallback_audio': 'False',
        'use_reftrack_embedded_subtitles': 'False',
        'use_reftrack_external_subtitles': 'False',
        'use_reftrack_external_subtitle_threshold': 'False',
        'use_reftrack_external_subtitle_threshold_value': '90',
        'use_offset': 'False',
        'use_offset_value': '0',
        'use_maxoffset_override': 'False',
        'use_maxoffset_value': '60',
        'use_gss': 'False',
        'use_blacklist_on_failed_sync': 'False',
    },
    'series_scores': {
        "hash": 359,
        "series": 180,
