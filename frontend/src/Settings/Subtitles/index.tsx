            ...
            <CollapseBox>
              ...
              <CollapseBox.Content>
                <Input>
                  ...
                  ></Selector>
                  <Message>
                    How much weeks must Bazarr wait after initial search to
                ...
                <Input>
                  ...
                  ></Selector>
                  <Message>
                    How often should Bazarr search for subtitles when in
          ...
          <Group header="Post-Processing">
            ...
            <CollapseBox>
              ...
              <CollapseBox.Content>
                <Input>
                  ...
                  ></Check>
                  <Message>
                    Do not actually sync the subtitles but generate a .tar.gz
                    file to be able to open an issue for ffsubsync. This file
                    will reside alongside the media file.
                  </Message>
                </Input>
                <CollapseBox>
                  <CollapseBox.Control>
                  ...
                  <CollapseBox.Control>
                    <Input>
                      <Check
                        ...
                        settingKey="settings-subsync-use_avanced_options"
                      ></Check>
                      <Message>
                        Enable advanced synchronization options.
                      </Message>
                    </Input>
                  </CollapseBox.Control>
                  <CollapseBox.Content>
                    <CollapseBox>
                      <CollapseBox.Control>
                        <Input>
                          <Check
                            label="Synchronize Using Reference SRT"
                            settingKey="settings-subsync-use_reftrack"
                          ></Check>
                          <Message>
                            A reference srt will be used instead of audio
                            extraction during synchronization.
                          </Message>
                        </Input>
                      </CollapseBox.Control>
                      <CollapseBox.Content>
                        <Input>
                          <Check
                            label="Enable Fallback Audio"
                            settingKey="settings-subsync-use_reftrack_fallback_audio"
                          ></Check>
                          <Message>
                            Use audio as fallback if no embedded/external srt is
                            found or if synchronization fails.
                          </Message>
                        </Input>
                        <Input>
                          <Check
                            label="Enable Embedded"
                            settingKey="settings-subsync-use_reftrack_embedded_subtitles"
                          ></Check>
                          <Message>Include embedded srt if found.</Message>
                        </Input>
                        <CollapseBox>
                          <CollapseBox.Control>
                            <Input>
                              <Check
                                ...
                                settingKey="settings-subsync-use_reftrack_external_subtitles"
                              ></Check>
                              <Message>Include external srt if found.</Message>
                            </Input>
                          </CollapseBox.Control>
                          <CollapseBox.Content>
                            <CollapseBox>
                              <CollapseBox.Control>
                                <Input>
                                  <Check
                                    label="Exteral Subtitle Score Threshold"
                                    settingKey="settings-subsync-use_reftrack_external_subtitle_threshold"
                                  ></Check>
                                </Input>
                              </CollapseBox.Control>
                              <CollapseBox.Content indent={false}>
                                <Input>
                                  <Slider settingKey="settings-subsync-use_reftrack_external_subtitle_threshold_value"></Slider>
                                </Input>
                              </CollapseBox.Content>
                            </CollapseBox>
                          </CollapseBox.Content>
                    ...
                    <CollapseBox>
                      <CollapseBox.Control>
                        <Input>
                          <Check
                            label="Apply Predefined Offset During Sync"
                            settingKey="settings-subsync-use_offset"
                          ></Check>
                        </Input>
                      </CollapseBox.Control>
                      <CollapseBox.Content>
                        <Input>
                          <Text
                            placeholder="0.00"
                            settingKey="settings-subsync-use_offset_value"
                          ></Text>
                          <Message>Amount in seconds (default 0)</Message>
                        </Input>
                      </CollapseBox.Content>
                    </CollapseBox>
                    <CollapseBox>
                      <CollapseBox.Control>
                        <Input>
                          <Check
                            label="Override Max Allowed Offset"
                            settingKey="settings-subsync-use_maxoffset_override"
                          ></Check>
                        </Input>
                      </CollapseBox.Control>
                      <CollapseBox.Content>
                        <Input>
                          <Text
                            placeholder="60"
                            settingKey="settings-subsync-use_maxoffset_value"
                          ></Text>
                          <Message>Amount in seconds (default 60).</Message>
                        </Input>
                      </CollapseBox.Content>
                    </CollapseBox>
                    <Input>
                      <Check
                        label="Use golden-Section Search (GSS)"
                        settingKey="settings-subsync-use_gss"
                      ></Check>
                      <Message>Default False.</Message>
                    </Input>
                    <Input>
                      <Check
                        label="Blacklist Downloaded SRT On Faild Sync"
                        settingKey="settings-subsync-use_blacklist_on_failed_sync"
                      ></Check>
                      <Message>Default False.</Message>
                    </Input>
                  </CollapseBox.Content>
            ...
            <CollapseBox>
              ...
              <CollapseBox.Content>
                ...
                <Message>
                  <b>{"{{episode_name}}"}</b> Filename of the episode without
                  parent directory or extension
                </Message>
                <Message>
                  <b>{"{{subtitles}}"}</b> Full path of the subtitles file
                </Message>
                <Message>
                  <b>{"{{subtitles_language}}"}</b> Language of the subtitles
                  file (may include HI or forced)
                </Message>
                <Message>
                  <b>{"{{subtitles_language_code2}}"}</b> 2-letter ISO-639
                  language code of the subtitles language (may include :hi or
                  :forced)
                </Message>
                <Message>
                  <b>{"{{subtitles_language_code2_dot}}"}</b> 2-letter ISO-639
                  language code of the subtitles language (same as previous but
                  with dot separator instead of colon)
                </Message>
                <Message>
                  <b>{"{{subtitles_language_code3}}"}</b> 3-letter ISO-639
                  language code of the subtitles language (may include :hi or
                  :forced)
                </Message>
                <Message>
                ...
                <Message>
                  <b>{"{{episode_language}}"}</b> Audio language of the episode
                  file
                </Message>
                <Message>
                  <b>{"{{episode_language_code2}}"}</b> 2-letter ISO-639
                  language code of the episode audio language
                </Message>
                <Message>
                  <b>{"{{episode_language_code3}}"}</b> 3-letter ISO-639
                  language code of the episode audio language
                </Message>
                <Message>
